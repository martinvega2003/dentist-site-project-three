...
export const ProfessionalCard = ({key, image, name, role, bio}) => {
  return (
    <div key={key} className="w-[90%] bg-white shadow-2xl rounded-3xl md:p-6 flex flex-col md:flex-row justify-start items-center md:items-start">
        <img
            src={image}
            alt={name}
            className="w-full md:w-[25%] max-h-[40%] md:h-[80%] rounded-lg mb-10 md:mb-0"
        />
